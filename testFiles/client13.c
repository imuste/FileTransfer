...
void writeAck4(info *theInfo);
void readData5(info *theInfo);
void writeAck7(info *theInfo);
void readData6(info *theInfo);
void writeAck8(info *theInfo);
...
void writeRRQ(info *theInfo)
{
        ...
        header1.msgType = 1;
        header1.winSeq = 3;
        strcpy(header1.data, "image2_GT.jpg");
...
void readData(info *theInfo)
{
        theInfo->fileContents = (char *)malloc(4297);
...
void writeAck8(info *theInfo)
{
        ...
        fwrite(theInfo->fileContents, 1, 4297, stdout);
}
